...
def generate_final_report(db_path: str, agent: OpenRouterAgent) -> str:
    ...
    # Ensure sources section has hyperlinks
    if "## Sources" not in report:
        sources_section = "\n\n## Sources\n" + report_agent.format_sources(structured_data)
        report += sources_section
    else:
        # Update existing sources section with hyperlinks
...
def main():
    try:
        ...
        # Generate report (without printing it here)
